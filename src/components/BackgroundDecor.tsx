  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(212,168,83,0.10) 0%, transparent 70%)",
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, transparent, rgba(212,168,83,0.2), transparent)",
      ...
      <div
        className="absolute bottom-[30%] left-[12%] h-14 w-14 rotate-45 border border-[rgba(212,168,83,0.15)]"
        style={{ animation: "float-slower 12s ease-in-out infinite" }}
      />

      {/* Floating rotated square — small */}
      <div
        className="absolute top-[40%] right-[10%] h-8 w-8 rotate-45 border border-[rgba(212,168,83,0.10)]"
        style={{ animation: "float-slower 12s ease-in-out infinite 4s" }}
      />

      {/* Floating dot — gold */}
      <div
        className="absolute top-[30%] left-[22%] h-2 w-2 rounded-full bg-[rgba(212,168,83,0.25)]"
        style={{ animation: "float-slow 8s ease-in-out infinite 1s" }}
      />

      {/* Floating dot — orange */}
      <div
        className="absolute top-[65%] right-[18%] h-1.5 w-1.5 rounded-full bg-[rgba(249,115,22,0.20)]"
